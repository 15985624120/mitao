<template>
    <div class="demo-fox body">
        <div class="snow"></div>
	        <div class="container">
		    <header class="header">
			<h1>选择风格颜色</h1>
			<nav class="demos">
				<a class="current-demo" href="hsq" title="Alex the CSS Husky"><img src="../assets/xz/link-husky.png" alt="Alex the Husky" class="border-hsq"/></a>
				<a href="javascript:;" title="Felix the CSS/SVG Fox"><img src="../assets/xz/link-fox.png" alt="Felix the Fox" class="border-hl"/></a>
			</nav>
			<p class="info">当前为粉色系风格<br/>旁边有棕色男孩风格哦！<br/>(确认风格请点击动物哦！亲)</p>
		</header>
...
.demo-fox #btn{
  ...
  width: 132px;
  height: 187px;
  border-radius: 102px 104px 75px 157px;
  border:none;
  outline: none;
  opacity: 0;
}
.border-hsq[data-v-3b57d709]{
    border: 5px solid #9b7159;
}
.border-hl[data-v-3b57d709]{
    border: 5px solid #ff6699;
    opacity: 0.5;
}
.demos a.current-demo img[data-v-3b57d709] {
    opacity: 0.9;
}
a {
	outline: none;
...
.content--fox {
  background: #99bfcf url("../assets/xz/landscape.jpg") no-repeat 50% 100%;
...
<script>
  // document.getElementById('shijian').onclick=()=>{
  //   console.log('123')
  // }
export default {
  data(){
